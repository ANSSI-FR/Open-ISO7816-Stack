...
#define READER_T1_CONTEXT_DEFAULT_CWT       (uint32_t)((2*2*2*2*2*2*2*2*2*2*2*2*2 + 11.0) * READER_UTILS_ComputeEtuMiliFloat(READER_HAL_DEFAULT_FI, READER_HAL_DEFAULT_DI, READER_HAL_DEFAULT_FREQ))
