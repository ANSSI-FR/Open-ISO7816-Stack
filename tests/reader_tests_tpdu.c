...
void test_READER_TPDU_IsACK_shouldWork(void){
	...
	TEST_ASSERT_FALSE(READER_TPDU_IsACK(0x60, 0x60) == READER_OK);
	TEST_ASSERT_FALSE(READER_TPDU_IsACK(0x61, 0x61) == READER_OK);
	TEST_ASSERT_FALSE(READER_TPDU_IsACK(0x69, 0x69) == READER_OK);
	TEST_ASSERT_FALSE(READER_TPDU_IsACK(0x90, 0x90) == READER_OK);
	TEST_ASSERT_FALSE(READER_TPDU_IsACK(0x92, 0x92) == READER_OK);
	TEST_ASSERT_FALSE(READER_TPDU_IsACK(0x99, 0x99) == READER_OK);
	TEST_ASSERT_FALSE(READER_TPDU_IsACK(0x01, 0x04) == READER_OK);
}
